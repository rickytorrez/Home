...
<html>
	...
	<body>
		...
		<!-- Listing Section -->
        <div class="w3-container" style="padding:260px 16px" id="listings">
            <h3 class="w3-center">THANKS FOR REACHING OUT</h3>
            <p class="w3-center w3-large">One of our agents will get back to you shortly</p>
		</div>
